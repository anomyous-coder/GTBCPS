...
def fl_config():
    ...
    config.poolSize = 1600
    config.trainSize = 1280
    config.testSize = 320
    config.predictSize = 1
...
def config():
    GTBCPS_config = ml_collections.ConfigDict()
    GTBCPS_config.days_range=90
    GTBCPS_config.computation_days=100
    return GTBCPS_config
